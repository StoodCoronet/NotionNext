...
const BLOG = {
  AUTHOR: 'Robye', // 作者
  BIO: 'ጿ ኈ ቼ ዽ ጿ', // 作者简介
  LINK: 'https://notion-next-robye.vercel.app/', // 网站地址
  ...
  CONTACT_EMAIL: 'huqy2022@shanghaitech.edu.cn',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/StoodCoronet',
  CONTACT_TELEGRAM: '',
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '无脑上Notion就完了', // 站点描述，被notion中的页面描述覆盖
